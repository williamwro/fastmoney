        ...
        <div className="max-w-2xl mx-auto">
          <div className="flex flex-col text-left mb-6">
            <h1 className="text-3xl font-bold tracking-tight">
              {isEditMode ? 'Editar Recebimento' : 'Novo Recebimento'}
            </h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              {isEditMode ? 'Atualize os detalhes da conta a receber' : 'Preencha os detalhes do novo recebimento'}
            </p>
          </div>
...
export default ReceivableFormWrapper;
