...
const BillsList: React.FC = () => {
  ...
  useEffect(() => {
    const filtered = filterBills(status, categoryFilter, searchQuery, 'pagar', startDate, endDate, dueStartDate, dueEndDate);
  ...
  const exportToPDF = () => {
    ...
    const tableColumn = ["Fornecedor", "Valor", "Vencimento", "Pagamento", "Categoria", "Status"];
        ...
        <div className="flex items-center gap-2 flex-wrap justify-end">
          <Popover open={dateRangeOpen} onOpenChange={setDateRangeOpen}>
            <PopoverTrigger asChild>
              <Button variant="outline" className={cn("flex items-center gap-1", (startDate || endDate) && "border-blue-500 bg-blue-50 text-blue-700 dark:bg-blue-900 dark:text-blue-200")}>
          ...
          <Popover open={dueRangeOpen} onOpenChange={setDueRangeOpen}>
            <PopoverTrigger asChild>
              <Button variant="outline" className={cn("flex items-center gap-1", (dueStartDate || dueEndDate) && "border-blue-500 bg-blue-50 text-blue-700 dark:bg-blue-900 dark:text-blue-200")}>
                <Calendar className="h-4 w-4 mr-1" />
                <span className={isMobile ? "" : "inline"}>
